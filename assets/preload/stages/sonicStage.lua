...
function onCreate()
	...
	setLuaSpriteScrollFactor('TAIL', 1, 1);
        ...
        makeLuaSprite('EGGMAN','EGGMAN_h',0,50)
	addLuaSprite('EGGMAN',false)
	setLuaSpriteScrollFactor('EGGMAN', 1, 1);

    	makeAnimatedLuaSprite('sonicJUMPSCARE','sonicJUMPSCARE',50,0)
    	addAnimationByPrefix('sonicJUMPSCARE','sonicSPOOK','sonicSPOOK',24,false)
		addLuaSprite('sonicJUMPSCARE',false)
		setObjectCamera('sonicJUMPSCARE','other')
		setProperty('sonicJUMPSCARE.visible',false)
end	
...
function onUpdate()
	...
	if curBeat == 433 then
		objectPlayAnimation('sonicJUMPSCARE','sonicSPOOK',false)
		playSound('datOneSound')
		setProperty('sonicJUMPSCARE.visible',true)
	end
